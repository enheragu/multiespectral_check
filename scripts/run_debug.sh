...
echo ""
echo "💡 Coverage tips:"
echo "  - View report: ./scripts/coverage/coverage_report.sh"
echo "  - Reset coverage: ./scripts/coverage/coverage_reset.sh"
echo "  - HTML report: ./scripts/coverage/coverage_html.sh"
echo "======================================================"
